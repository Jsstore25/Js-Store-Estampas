    ...
    <header className="bg-brand-dark py-4 px-6 md:px-12 sticky top-0 z-50 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="https://api.whatsapp.com/send?phone=5531991687046&text=Oi%2C%20tudo%20bem%3F%20Quero%20fazer%20um%20or%C3%A7amento." target="_blank" rel="noopener noreferrer" className="text-white hover:text-brand-yellow transition-colors">
            <WhatsappIcon />
          </a>
        </div>
      </div>
