...
// Fix: Added an id to each FAQ item to match the updated FaqItem type.
...
export const PRICING_DATA: PricingCategory[] = [
  {
    ...
    tiers: [
      { quantity: 12, price: 'R$ 30 (Cada)' },
      { quantity: 20, price: 'R$ 29 (Cada)' },
      { quantity: 30, price: 'R$ 28 (Cada)' },
      { quantity: 50, price: 'R$ 27 (Cada)' },
      { quantity: 100, price: 'R$ 26 (Cada)' },
    ],
  },
  {
    title: 'Over 100% algodão 30.1',
    tiers: [
      { quantity: 12, price: 'R$ 36 (Cada)' },
      { quantity: 20, price: 'R$ 35 (Cada)' },
      { quantity: 30, price: 'R$ 33,50 (Cada)' },
      { quantity: 50, price: 'R$ 32,50 (Cada)' },
  ...
  },
  {
    ...
    tiers: [
      { quantity: 12, price: 'R$ 37 (Cada)' },
      { quantity: 20, price: 'R$ 36 (Cada)' },
      { quantity: 30, price: 'R$ 35 (Cada)' },
      { quantity: 50, price: 'R$ 34 (Cada)' },
      { quantity: 100, price: 'R$ 32 (Cada)' },
    ],
  },
  {
    title: 'Over Suedine',
    tiers: [
      { quantity: 12, price: 'R$ 50 (Cada)' },
      { quantity: 20, price: 'R$ 48 (Cada)' },
      { quantity: 30, price: 'R$ 45 (Cada)' },
      { quantity: 50, price: 'R$ 44 (Cada)' },
      { quantity: 100, price: 'R$ 43 (Cada)' },
    ],
  },
];
